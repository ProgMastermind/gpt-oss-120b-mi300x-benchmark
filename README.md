...
| Engine | Image | Config | Throughput (tok/s) |
|--------|-------|--------|-------------------|
| vLLM 0.24.0 | `vllm/vllm-openai-rocm:v0.24.0` | AITER unified attention, full/piecewise CUDA graphs, `--gpu-memory-utilization 0.85`, `--max-num-seqs 256` | ~74 |
| ATOM 0.1.5 | `rocm/atom-dev:atom0.1.5-aiter0.1.16` | **base** (official recipe) | 194.6 |
| ATOM 0.1.5 | `rocm/atom-dev:atom0.1.5-aiter0.1.16` | **best + full graph** (`FULL_AND_PIECEWISE` decode graphs) | 196.1 |
| ATOM 0.1.5 | `rocm/atom-dev:atom0.1.5-aiter0.1.16` | **best CLI** (piecewise CUDA graphs) | 200.6 |
| ATOM 0.1.5 | `rocm/atom-dev:atom0.1.5-aiter0.1.16` | **base** with profiling enabled | 167.6 |

ATOM on the paired `0.1.5` image is ~2.7x faster than the vLLM 0.24.0 baseline on the same single-MI300X setup.
